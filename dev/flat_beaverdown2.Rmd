...
#' @export
    initialize = function(Mode = NULL, suffix1 = "_R1.fastq.gz",suffix2 = NULL,
      ...
      self$CGI = CGI
      self$gnome_fasta = list(gnome_fasta)
      self$genomeFile = list(genomeFile)
      self$rnaseq_gtf = list(rnaseq_gtf)
      self$rnaseq_ref = list(rnaseq_ref)
      self$genomeAnno = list(genomeAnno)
      ...
      #}
      self$adapter1 <- list(trimSeq1)
      self$adapter2 <- list(trimSeq2)
      message(">> Done!")
      self$gandalf_info()
...
#'
    ...
    gandalf_make_config = function(returnData = FALSE,
                                   writePdata = TRUE){
      ...
      if (writePdata){
        ...
        self$run_log <- c(self$run_log,
                        ">> writing pdata tables ...")
        openxlsx::write.xlsx(self$pdata,
                             paste0(self$selfconfig,"/pdata.xlsx"))
      }
      if (returnData){
